...
status: active
tags: [claude-code, security, permissions, bash, deny-rules]
sources:
  - type: reddit
...
embedded: false
resolutions:
  one_line: "Bash commands (grep, find) bypass Read() deny rules — they scan everything including node_modules even with deny rules configured."
  standard: |
