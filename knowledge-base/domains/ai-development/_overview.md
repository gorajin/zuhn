...
> 117 insights across 10 topics

## Topics

| Topic | Insights | Preview |
| ----- | -------- | ------- |
| agent-patterns | 7 | When agents fail, the instinct now is 'I gave bad instructions' not 'the AI can't do this' — most failures are configuration problems, not capability limits. |
