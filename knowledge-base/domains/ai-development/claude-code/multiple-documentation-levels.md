...
topic: claude-code
title: "Use multiple documentation levels from broad architecture to specific API references"
actionability: immediate
confidence: high
shelf_life: evergreen
status: active
tags: [documentation, architecture, codebase-navigation, multi-level]
sources:
  - type: reddit
    title: "Claude Code is a Beast – Tips from 6 Months of Hardcore Use"
    author: u/diet103
    url: "https://reddit.com/r/ClaudeCode"
related: [INS-260320-F872, INS-260320-A4BF]
