...
status: active
tags: [llm-costs, input-filtering, preprocessing, cost-reduction]
sources:
  - type: reddit
...
embedded: false
resolutions:
  one_line: "Filter aggressively before hitting expensive models — filtering by upvotes/comments removes 80% of inputs, saving ~$5/week."
  standard: |
