...
topic: claude-code
title: "Hook pipeline: Claude responds then Prettier formats then build checker then error reminder"
actionability: immediate
confidence: high
shelf_life: evergreen
status: active
tags: [hooks, pipeline, workflow, Prettier, build-checker, error-handling]
sources:
  - type: reddit
    title: "Claude Code is a Beast – Tips from 6 Months of Hardcore Use"
    author: u/diet103
    url: "https://reddit.com/r/ClaudeCode"
related: [INS-260320-0D43, INS-260320-4DE2, INS-260320-7379]
...
embedded: false
resolutions:
  one_line: "The full hook pipeline runs in sequence: Claude responds, Prettier formats code, build checker catches errors, error reminder does a self-check — zero errors left behind."
  standard: |
