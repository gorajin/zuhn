...
status: active
tags: [spec-driven-dev, git, context-preservation, agent-continuity]
sources:
  - type: reddit
...
embedded: false
resolutions:
  one_line: "Commit output specs to git so future agents and engineers see what was done, what failed, and what decisions were made."
  standard: |
