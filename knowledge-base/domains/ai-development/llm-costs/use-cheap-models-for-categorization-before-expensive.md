...
status: active
tags: [llm-costs, model-routing, categorization, tiered-processing]
sources:
  - type: reddit
...
embedded: false
resolutions:
  one_line: "Use cheap models (gpt-5-nano) for categorization/relevance scoring before expensive models — removes 70-90% of irrelevant inputs."
  standard: |
